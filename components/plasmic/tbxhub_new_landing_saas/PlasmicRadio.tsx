...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: WtGI3q60A8ea/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames("all", sty.freeBox__aneV)}>
        <div className={classNames("all", sty.freeBox__zzLss)} />
      </div>
      {renderPlasmicSlot({
