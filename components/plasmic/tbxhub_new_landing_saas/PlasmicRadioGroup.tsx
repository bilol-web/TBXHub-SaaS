...
import Radio from "../../Radio"; // plasmic-import: WtGI3q60A8ea/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: 5j7H3srKYzuX/css
...
function PlasmicRadioGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames("all", sty.freeBox__iLxMd)}>
            <Radio
              className={classNames("__wab_instance", sty.radio__jwqn0)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__qA7)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__my8I)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
