...
export type ShopifyComLogo0SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function ShopifyComLogo0SvgIcon(props: ShopifyComLogo0SvgIconProps) {
...
export default ShopifyComLogo0SvgIcon;
/* prettier-ignore-end */
