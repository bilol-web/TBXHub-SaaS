...
export type StripeLogo0SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function StripeLogo0SvgIcon(props: StripeLogo0SvgIconProps) {
...
export default StripeLogo0SvgIcon;
/* prettier-ignore-end */
