...
import Label from "../../Label"; // plasmic-import: nyu1wXOoiF0C/component
import TextInput from "../../TextInput"; // plasmic-import: 3syfkbdU3243/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: 6ir39UQjqtQh/component
import Description from "../../Description"; // plasmic-import: RmE-e_VZ4cB6/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: 0XV_zh1-SBYt/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames("all", sty.freeBox__iZ2V0, {
          [sty.freeBoxiconEnd__iZ2V0BTkFl]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__iZ2V0XFhi]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__iZ2V0XzjxW]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames("all", sty.freeBox__trGrU, {
            [sty.freeBoxiconStart__trGrUxFhi]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__trGrUxzjxW]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg__gU27)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames("all", sty.freeBox__pqPsR, {
            [sty.freeBoxiconEnd__pqPsRbTkFl]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__pqPsRxFhi]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg__c9VRj)}
                role={"img"}
              />
            ),
