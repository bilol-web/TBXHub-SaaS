...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: hGFeQYsJZJlJ/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: j9CaboHqQouc/css
  ...
  return (
    <BaseDialogTrigger
      ...
      dialog={
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames("all", sty.freeBox__qTqFr)}>
                  <div
                    className={classNames("all", "__wab_text", sty.text__hKiCj)}
                  >
                    {"This is a Popover!"}
                  </div>
                  <div
                    className={classNames("all", "__wab_text", sty.text__mfDp4)}
                  >
                    {"You can put anything here!"}
                  </div>
                  <div
                    className={classNames("all", "__wab_text", sty.text__vJ4Lh)}
                  >
                    {
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button__qgnib)}
            label={"Open Popover"}
          />
        ),
