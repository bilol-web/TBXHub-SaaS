...
import MenuPopover from "../../MenuPopover"; // plasmic-import: _8yslLl1TL9C/component
import MenuItem from "../../MenuItem"; // plasmic-import: 2DmRe2h6qRkC/component
import MenuSection from "../../MenuSection"; // plasmic-import: kxCRyghfJlsh/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: KX8aRrZK7nyp/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__sE3DE)}
                header={
                  <div
                    className={classNames("all", "__wab_text", sty.text__kMmLk)}
                  >
                    {"Section"}
                  </div>
                }
