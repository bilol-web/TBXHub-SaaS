...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: KBWpqfAgH2ZW/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: 2Nysxsn12Vga/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: LMrTa0P6pdEs/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames("all", sty.svg__eCf0)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames("all", sty.svg__uuAhb)}
            role={"img"}
          />
        ) : null}
      </div>
