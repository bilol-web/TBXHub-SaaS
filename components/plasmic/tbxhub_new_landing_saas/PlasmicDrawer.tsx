...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: jmVz8Va6gHfc/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_-H5bQvYw3mr6"]]: true })}
        ...
        >
          ...
          >
            <div className={classNames("all", sty.freeBox__jz7Nn)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <h2
                    className={classNames(
              ...
              >
                {renderPlasmicSlot({
                  defaultContents: (
                    <div className={classNames("all", sty.freeBox___80K8O)}>
                      <div
                        className={classNames(
                          "all",
                          "__wab_text",
              ...
              <div className={classNames("all", sty.freeBox___2Zm7J)}>
                {renderPlasmicSlot({
                  defaultContents: (
                    <div className={classNames("all", sty.freeBox__u3JQq)}>
                      <Button
                        color={"muted"}
                        label={"Close"}
                        onClick={async event => {
      ...
      trigger={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__qDuV9)}
                  label={
                    <div
                      className={classNames(
                        "all",
