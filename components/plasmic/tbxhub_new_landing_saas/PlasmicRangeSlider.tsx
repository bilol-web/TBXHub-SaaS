...
import SliderThumb from "../../SliderThumb"; // plasmic-import: GYf6wJv5xUeZ/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: hlMiN7a49xqw/css
...
function PlasmicRangeSlider__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames("all", sty.freeBox__jQinQ)}>
        {$props.showLabel ? (
          <Label
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div
                  className={classNames("all", "__wab_text", sty.text__jB2Hp)}
                >
                  {"Label"}
                </div>
              ),
      ...
      <div className={classNames("all", sty.freeBox__utNxH)}>
        <div
