...
import sty from "./PlasmicModal.module.css"; // plasmic-import: KjyWR2BvOFdb/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_LxgEqRzykSzw"]]: true })}
        ...
        >
          ...
          >
            ...
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <div className={classNames("all", sty.freeBox___3HHq7)}>
                    <div
                      className={classNames(
                        "all",
                        "__wab_text",
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames("all", sty.freeBox__tkpAp)}>
                  <Button
                    color={"muted"}
                    label={
                      <div
