...
import sty from "./PlasmicTooltip.module.css"; // plasmic-import: PlPJmJh0gwSh/css
...
function PlasmicTooltip__RenderFunc(props: {
  ...
  return (
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  <div
                    className={classNames("all", "__wab_text", sty.text__gtyV)}
                  >
                    {"Hello from Tooltip! "}
                  </div>
                  <div
                    className={classNames("all", "__wab_text", sty.text__jmQni)}
                  >
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames("all", "__wab_text", sty.text__dcz1M)}>
            {"Hover me!"}
          </div>
        ),
        value: args.trigger,
