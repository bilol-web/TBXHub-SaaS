...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: 2DmRe2h6qRkC/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames("all", sty.freeBox___7CVjW)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames("all", sty.freeBox__rWvl4)}>
            <div className={classNames("all", "__wab_text", sty.text__gbT5Q)}>
              <React.Fragment>
                {(() => {
                  try {
                    return $props.label;
        ...
        {(() => {
          ...
          <BaseText2
            ...
            slot={"description"}
          >
            <div className={classNames("all", "__wab_text", sty.text__hgIqx)}>
